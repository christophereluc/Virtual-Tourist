...
class APIClient : NSObject {
    ...
    func taskForGETMethod(params: [String:AnyObject], completionHandlerForGET: (result: AnyObject!, error: NSError?) -> Void) -> NSURLSessionDataTask {
        
        var parameters = params;
        /* 1. Set the parameters */
        parameters[FlickrParameterKeys.APIKey] = Constants.APIKey
